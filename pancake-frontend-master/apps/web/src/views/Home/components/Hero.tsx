      ...
      >
        <Flex flex="1" flexDirection="column">
          <Heading scale="xxl" color="secondary" mb="24px">
            {t('New Generation DEX on Ethereum,BSC & Polygon Networks')}
          </Heading>
          <Heading scale="md" mb="24px">
            {t('Oboswap is the home of DeFi. Our community is building a comprehensive, decentralized trading platform for the future of finance. Join us!')}
          </Heading>
          <Flex>
